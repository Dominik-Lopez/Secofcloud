...
print"<script>alert(\"Registro Agregado Exitosamente.\") ;window.location='View_per.php'</script>";
}
    
         public function Update_persona($id_Persona,$id_Persona2,$username,$Passsword,$Nombre,$Seg_nombre,$Apellido,$Seg_apellido,$Direccion,$Email,$telefono,$Tipo_Documento_Tipo_Doc,$fk_rol)
         {
             ...
             email = '$Email',
             telefono = '$telefono',
             tipo_documento_tipo_doc = '$Tipo_Documento_Tipo_Doc',
             fk_rol ='$fk_rol'
             WHERE id_persona ='$id_Persona2'";
         ...
         public function Delete_pesona($id_Persona)
         {
             ...
             print"<script>alert(\"Registro eliminado Exitosamente.\");window.location='View_per.php'</script>";
         }
     } 
