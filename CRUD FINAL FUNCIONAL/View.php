...
<p><label>MACHINE - ACCESSORY STATE:</label>
 ...
 <br> Active<input type="radio" name="tip_doc" value="1"<?php echo $row['tipo_documento'] === '1' ? 'checked' : ''?> >
 inactive<input type="radio" name="tip_doc" value="0"<?php echo $row['tipo_documento'] === '0' ? 'checked' : ''?> >
