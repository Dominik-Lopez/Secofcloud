...
<input type="text" name="estado" value="<?php echo $row["Estado_tdoc"];?>" placeholder="Estado" required>
...
<p><label>Estado Tipo Documento:</label>

 <br> Active<input type="radio" name="tip_doc" value="1"<?php echo $row['Estado_tdoc'] == '1' ? 'checked' : ''?> >
 inactive<input type="radio" name="tip_doc" value="0"<?php echo $row['Estado_tdoc'] == '0' ? 'checked' : ''?> >
